    ...
    <>
      ...
      {members.length > 0 ? (
        <>
          ...
          <div className="grid grid-cols-3 gap-x-4" style={{ marginTop: '6px', marginBottom: '28px', rowGap: '10px' }}>
            {members.map((member) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-base font-hand ${isPresent ? 'text-[#4a3b22] font-semibold' : 'text-[#5c5030]'}`}>
                    {member.name}
                  </span>
                </label>
              );
